...
public class LoginTest {
   ...
   Login login = new Login();
    login.registerUser("kyl", "nkala", "kyl_1", "Ch&&sec@ke99!", "+27821234567");
   String expected = "Welcome kyl,nkala. It is nice to see you again.";
   String Actual = login.returnLoginStatus("kyl_1", "Ch&&sec@ke99!");
   assertEquals(expected, Actual,"Welcome kyl,nkala. It is nice to see you again.");
   }
